...
class ShapUtils {
    ...
    static func shapeINVMarker(markerDictionary: [String:CafeData], mapView: InaviMapView) {
    ...
    static func shapeCircleRange(trkDataArray: [TrkData], mapView: InaviMapView) {
